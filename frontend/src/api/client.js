...
export const fetchOverview = () => api.get('/sensors/overview')
export const fetchSensorTimeseries = (deviceId, keys, hours = 24) =>
    api.get(`/sensors/${deviceId}/timeseries`, { params: { keys, hours } })
